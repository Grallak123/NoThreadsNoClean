    ...
    public ArrayList<Book> executeQuery2(String query) throws SQLException {
         ...
         try {
                    ...
                    try{
                        if(!tmpSeenISBNList.contains(tmpBookList.get(0))){
                           ...
                           temporaryBookList.get(bookCounter).getTheAuthors().add
                            (new Author(rs.getString(6),rs.getString(7),rs.getString(8)));
            ...
            if(ItsTreasonThen){
               ...
               temporaryBookList = executeOrder66(Order66,temporaryBookList);
            }
            
            if(ItsTreasonThen){
                temporaryBookList = unternehmenClauswitz(temporaryBookList);
            }
...
//                        laBook.getTheReviews().add(new Review(russia.getString(2),
  //                      russia.getString(3),russia.getString(4),russia.getString(5)));
                     //  String tmpaISBN = laBook.getIsbn();
    ...
    public void executeDeleteAuthor(String deleteAuthorQuery) throws SQLException {
        ...
        try {
            ...
            try{
                ...
                stmt1.executeUpdate(deleteAuthorQuery);
                //add authors an authorof for size of authorsList
               // ArrayList<Statement> stmtArrayList1 = null;
               // ArrayList<Statement> stmtArrayList2 = null;
...
/*final ArrayList<Book> bookResult  = model.executeQuery2(customQuery);
javafx.application.Platform.runLater(new Runnable(){
publi void run(){

    safeRoom1(bookResult)}
});*/